    ...
    <div className="max-w-5xl mx-auto">
      <section className="mb-4 py-12 bg-blue-50 rounded-lg">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8" style={{ alignItems: 'flex-end' }}>
            <div className="text-center lg:text-left flex-1" style={{ alignSelf: 'flex-end' }}>
            ...
            <div className="flex justify-center lg:justify-end" style={{ alignSelf: 'flex-end' }}>
              <img 
