              ...
              <div className="text-sm text-slate-600 leading-relaxed mb-6 space-y-4" style={{ fontFamily: '"Noto Sans KR", "Apple SD Gothic Neo", -apple-system, sans-serif' }}>
                <p>
                  {t(
                    ...
                    'Americans save only 4-5% of their income. However, research shows that even with excellent investment returns, this level of saving cannot maintain your current lifestyle in retirement. While it varies by age, you need to save at least 20% before "maximizing risk-adjusted returns" becomes meaningful.'
                  )}
                </p>
                <p>
                  {t(
