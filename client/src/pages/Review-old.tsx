...
const Review: React.FC = () => {
  ...
  const taxData = {
    id: 1,
    status: 'in_progress',
    personalInfo: { filingStatus: 'single', firstName: '', lastName: '', ssn: '', dateOfBirth: '', numberOfChildren: 0, numberOfOtherDependents: 0 },
    ...
    calculatedResults: { totalIncome: 0, adjustments: 0, adjustedGrossIncome: 0, deductions: 27700, taxableIncome: 0, federalTax: 0, credits: 0, taxDue: 0, payments: 0, refundAmount: 0, amountOwed: 0 }
  };
