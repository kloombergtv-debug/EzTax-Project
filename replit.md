...
Recent Changes:
- July 26, 2025: **PRIVACY-FOCUSED USER GUIDANCE ENHANCED** - Updated personal information page guidance message to emphasize privacy protection: "개인정보보호를 위해 시뮬레이션을 위해서는 생년월일과 거주지만 정확하게 입력하시고 나머지 정보는 작성하지 않으셔도 됩니다" replacing previous tax filing language with simulation-focused privacy messaging
